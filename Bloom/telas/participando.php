...
if($eventos){
 ...
 echo '<div class="col-md-4">';
    ...
    align-items: center;
    justify-content: center;">
                                <form action="../validacoes/comentarios.php" method="POST">
                                    <?php
                                ...
                                <?php 
               echo '  <form id="formSair" method="post" action="../validacoes/sair_evento.php" onsubmit="return confirm(\'Tem certeza que deseja sair do evento?\')">';
  ...
  <form  action="../validacoes/validarSairBtnOngs.php">
  <div class="caixabtn">  
