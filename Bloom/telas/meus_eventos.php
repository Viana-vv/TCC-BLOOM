...
<body>
  ...
  <div class="container text-center mt-4">
    ...
    align-items: center;
    justify-content: center;">
                                <form action="../validacoes/chatOngs.php" method="POST">
                                    <?php
                                ...
                                <?php 
          echo '  <form id="formCancelar" method="post" action="../validacoes/cancelar_evento.php" onsubmit="return confirm(\'Tem certeza que deseja cancelar o evento?\')">';
