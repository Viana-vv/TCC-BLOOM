...
$sql = "SELECT nome, cnpj, telefone , email , rua , bairro , estado , estatuto, data_fundacao, data_registro, imagens FROM ongs  WHERE id_ongs = ?";
...
<body>
    <form action="../validacoes/atualizarOngs.php" method="post" enctype="multipart/form-data">
        <div class="caixa">
            <div class="caixa1">
            ...
            if ($result->num_rows > 0) {
              ...
              echo '<fieldset disabled>';
              echo ' <p>CNPJ</p>';
              echo '<input type="number" id="disabledTextInput" class="form-control" placeholder="' . $row['cnpj'] . '">';
             echo '<li>';
             echo '<fieldset disabled>';
              echo ' <p>Data de registro</p>';
              echo '<input type="number" id="disabledTextInput" class="form-control" placeholder="' . $row['data_registro'] . '">';
               echo '<li>';
               echo '</fieldset>';
             echo '<fieldset disabled>';
              echo ' <p>Data de fundação</p>';
              echo '<input type="number" id="disabledTextInput" class="form-control" placeholder="' . $row['data_fundacao'] . '">';
              echo '</fieldset>';
              echo '<li>';
              echo '</fieldset>';
              echo '<p>Email</p>';
              ...
              echo '</form>';
              echo '<li>';
              echo '<form action="../validacoes/sairbtnperfilong.php" method="post">';
